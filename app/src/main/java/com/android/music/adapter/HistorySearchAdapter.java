...
/**
 * Created by 移动应用开发三人组 on 2024/4/10.
    ...
    public void onBindViewHolder(@NonNull HistorySearchAdapter.ViewHolder holder, final int position) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* //发送广播，根据关键字搜索歌曲
                Intent intent = new Intent("com.android.music.ui.search.searchFragment.SearchReceiver");
                intent.putExtra("key",key);
                intent.setComponent(new ComponentName("com.android.music","com.android.music.ui.search.searchFragment.SearchReceiver"));
